...
Shader "Shape"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( 1.0 - step( dotResult60 , 0.99 ) ) + ( ( ( lerpResult33 + screenColor37 ) * 1.0 ) * ( ( ( dotResult1_g1 + 1.0 ) / 2.0 ) * 1 ) ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=15900
-1920;75;1758;947;-1588.792;84.82083;1;True;True
...
Node;AmplifyShaderEditor.ColorNode;34;517.6943,-245.3181;Float;False;Property;_ColorB;ColorB;2;0;Create;True;0;0;False;0;1,1,1,0;0.2941173,0.4676295,0.9607843,0;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=E2E6B8E69ABB52F36C0541B72733E7797CDF745E