...
Shader "Shape"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( ( lerpResult33 + screenColor37 ) * 1.0 ) * ( ( ( dotResult1_g1 + 1.0 ) / 2.0 ) * 1 ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=15900
-1920;75;1758;947;-390.9813;882.6487;1.629948;True;True
...
Node;AmplifyShaderEditor.FunctionNode;52;1978.871,155.4221;Float;False;SF_Lighting;-1;;1;e0e44f51f8b410b4a95e500ff225fd18;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=AF4FC20A02FD2C02F179E88F806256BEF8ED877B