...
Shader "HandpaintedMesh"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float mulTime5 = _Time.y * 3.0;
			float temp_output_9_0 = ( floor( mulTime5 ) * 0.1 );
			float2 uv_TexCoord7 = v.texcoord.xy * _Displacement_ST.xy;
			float2 temp_cast_0 = (temp_output_9_0).xx;
			float3 temp_cast_1 = (( ( sin( ase_vertex3Pos.y ) * tex2Dlod( _Displacement, float4( ( temp_output_9_0 + uv_TexCoord7 ), 0, 0.0) ).r * _Displace ) + ( tex2Dlod( _TextureSample0, float4( temp_cast_0, 0, 0.0) ).r * _Shake ) )).xxx;
...
/*ASEBEGIN
Version=15900
38;397;1298;622;940.7555;-268.333;1;True;False
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;7;-821.8871,67.20302;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;8;-593.0871,177.703;Float;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;37.87732,382.8075;Float;False;Property;_Displace;Displace;3;0;Create;True;0;0;False;0;0.05;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-177.7555,510.333;Float;False;Property;_Shake;Shake;4;0;Create;True;0;0;False;0;0.25;0.25;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=EABE4C3ECB745A399E15E28B561787035959DB62